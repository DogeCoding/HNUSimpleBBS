...
class JokeViewSectionController: ListSectionController {
    ...
    fileprivate func modelTrans(model: BaseModel) -> JokeOrPctCellViewModel {
        ...
        return JokeOrPctCellViewModel(content: content, largeImageUrl: largeImageUrl, isJoke: true)
    }
}
