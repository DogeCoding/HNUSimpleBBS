...
typedef SWIFT_ENUM(NSInteger, IQAutoToolbarManageBehaviour) {
...
/// setting is disabled.
typedef SWIFT_ENUM(NSInteger, IQEnableMode) {
...
typedef SWIFT_ENUM(NSInteger, IQPreviousNextDisplayMode) {
